...
@Component({
	...
	template: `
		<ion-header no-border>
			<ion-navbar style="padding-top: env(safe-area-inset-top); padding-top: 30px;">
			</ion-navbar>
		</ion-header>
